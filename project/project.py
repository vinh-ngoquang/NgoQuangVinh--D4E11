...
#season_num = [274,274,274,54,42,27,22,21,20,19,18,17,16,15,14,13,12,11,10]
x = 0 #season_num
page_size = 1000
page_num = 0
...
for y in range(9):
    l = []
    url = f'https://footballapi.pulselive.com/football/stats/ranked/players/{criteria[y]}?page={page_num}&pageSize={page_size}&compSeasons=274&comps=1&compCodeForActivePlayer=EN_PR&altIds=true'
    headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) coc_coc_browser/85.0.134 Chrome/79.0.3945.134 Safari/537.36',
               ...
               'method': 'GET',
               'path': f'/football/stats/ranked/players/{criteria[y]}?page={page_num}&pageSize={page_size}&compSeasons=274&comps=1&compCodeForActivePlayer=EN_PR&altIds=true',
               'scheme': 'https',
               'accept': '*/*',
