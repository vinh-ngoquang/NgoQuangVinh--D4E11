...
for y in range(9):
    l = []
    url = f'https://footballapi.pulselive.com/football/stats/ranked/players/{criteria[y]}?page=0&pageSize=50&compSeasons=274&comps=1&compCodeForActivePlayer=EN_PR&positions=GOALKEEPER&altIds=true'
    headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) coc_coc_browser/85.0.134 Chrome/79.0.3945.134 Safari/537.36',
               ...
               'method': 'GET',
               'path': f'https://footballapi.pulselive.com/football/stats/ranked/players/{criteria[y]}?page=0&pageSize=50&compSeasons=274&comps=1&compCodeForActivePlayer=EN_PR&positions=GOALKEEPER&altIds=true',
               'scheme': 'https',
               'accept': '*/*',
    ...
    print(f'crawling {criteria[0]} done!')
